...
@Component
public class CibilCryptoUtils {

    /*
      public static final String CIBIL_SYMMETRIC_KEY_ENCRYPT_ALGO = "AES256/CBC/PKCS5Padding";
        The correct transformation name is without the “256”:
        Cipher.getInstance("AES/CBC/PKCS5Padding")
        The key length (128 / 192 / 256) is determined automatically from the length of the key bytes you pass (16 / 24 / 32).
    */
    public static final String CIBIL_SYMMETRIC_KEY_ENCRYPT_ALGO = "AES/CBC/PKCS5Padding";
    public static final String CIBIL_ASYMMETRIC_KEY_ENCRYPT_ALGO = "RSA/ECB/PKCS1Padding";
    ...
    public String rsaEncryptKey(byte[] aesKey, PublicKey publicKey) throws Exception {
        Cipher cipher = Cipher.getInstance(CIBIL_ASYMMETRIC_KEY_ENCRYPT_ALGO);
    ...
    public String aesEncryptPayload(String payload, byte[] aesKey, byte[] iv) throws Exception {
        Cipher cipher = Cipher.getInstance(CIBIL_SYMMETRIC_KEY_ENCRYPT_ALGO);
