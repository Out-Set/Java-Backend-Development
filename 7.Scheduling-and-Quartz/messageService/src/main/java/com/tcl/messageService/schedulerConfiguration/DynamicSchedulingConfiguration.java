package com.tcl.messageService.schedulerConfiguration;
...
public class DynamicSchedulingConfiguration implements SchedulingConfigurer {
    ...
    @Bean
    public CronTaskService taskService(ScheduledTaskRegistrar taskRegistrar, Map<String, ScheduledTaskInfo> scheduledTasks) {
        return new CronTaskService(taskRegistrar, scheduledTasks);
    }
